              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <span className={`text-[10px] font-medium px-2 py-0.5 rounded ${gateColors[approval.gate] || 'bg-slate-100 text-slate-500'}`}>
                      {approval.gate}
                    </span>
                ...
                {approval.agentReviews && approval.agentReviews.length > 0 && (
              ...
              return (
                <>
                  ...
                  <div className="bg-slate-50 rounded-xl p-3 mb-4">
                    ...
                    <div className="text-xs text-slate-700">{approval.submitter}</div>
