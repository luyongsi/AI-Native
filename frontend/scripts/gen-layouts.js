...
const base = 'D:/Vibe Coding/AI Agent/frontend/src/app';

// ============================================================
// MC Layout - Mission Control sidebar
// ============================================================
const mcLayout = `'use client';
...
const target1 = path.join(base, 'mc', 'layout.tsx');
fs.writeFileSync(target1, mcLayout, 'utf8');
console.log('MC layout written:', mcLayout.length, 'bytes');

// ============================================================
// Workbench Layout
// ============================================================
const wbLayout = `'use client';
...
const target2 = path.join(base, 'workbench', 'layout.tsx');
fs.writeFileSync(target2, wbLayout, 'utf8');
console.log('Workbench layout written:', wbLayout.length, 'bytes');
